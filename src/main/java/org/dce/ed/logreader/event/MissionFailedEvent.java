...
public final class MissionFailedEvent extends EliteLogEvent {

    private final long missionId;
    private final String name;
    private final String localisedName;

    public MissionFailedEvent(Instant timestamp, JsonObject rawJson) {
        super(timestamp, EliteEventType.MISSION_FAILED, rawJson);
